...
public:
        ...
        ) const
    {
        ...
        {
            return M0.Sample(ModelHitPoint, AdditionalData, SurfaceNormal, ModelToWorld, Allocator);
        }
        
        return M1.Sample(ModelHitPoint, AdditionalData, SurfaceNormal, ModelToWorld, Allocator);
    }
