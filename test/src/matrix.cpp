...
{
    INVERTIBLE_MATRIX Matrix1, Matrix2;
    ISTATUS Status;

    Status = MatrixInitializeIdentity(&Matrix1);

    CHECK_EQUAL(ISTATUS_SUCCESS, Status);

    Status = MatrixInitializeTranslation(&Matrix2,
                                         (FLOAT) 1.0,
                                         (FLOAT) 2.0,
                                         (FLOAT) 3.0);
    ...
    Status = MatrixMultiply(&Matrix1, &Matrix2, &Matrix1);

    CHECK_EQUAL(ISTATUS_SUCCESS, Status);

    CHECK_EQUAL((FLOAT) 1.0, Matrix1.Matrix.M[0][0]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[0][1]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[0][2]);
    CHECK_EQUAL((FLOAT) 1.0, Matrix1.Matrix.M[0][3]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[1][0]);
    CHECK_EQUAL((FLOAT) 1.0, Matrix1.Matrix.M[1][1]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[1][2]);
    CHECK_EQUAL((FLOAT) 2.0, Matrix1.Matrix.M[1][3]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[2][0]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[2][1]);
    CHECK_EQUAL((FLOAT) 1.0, Matrix1.Matrix.M[2][2]);
    CHECK_EQUAL((FLOAT) 3.0, Matrix1.Matrix.M[2][3]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[3][0]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[3][1]);
    CHECK_EQUAL((FLOAT) 0.0, Matrix1.Matrix.M[3][2]);
    CHECK_EQUAL((FLOAT) 1.0, Matrix1.Matrix.M[3][3]);

    CHECK_EQUAL(&Matrix1.Inverse, Matrix1.Matrix.Inverse);
    CHECK_EQUAL(&Matrix1.Matrix, Matrix1.Inverse.Inverse);
}