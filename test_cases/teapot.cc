...
TEST(TeapotTest, FlatShadedTeapotBvh)
{
    PCOLOR_EXTRAPOLATOR color_extrapolator;
    ISTATUS status = ColorColorExtrapolatorAllocate(COLOR_SPACE_XYZ,
                                                    &color_extrapolator);
    ...
    PSCENE scene;
    status = BvhSceneAllocate(shapes,
                              nullptr,
                              nullptr,
                              triangles_allocated,
                              nullptr,
...
TEST(TeapotTest, SmoothShadedTeapotBvhAggregate)
{
    PCOLOR_EXTRAPOLATOR color_extrapolator;
    ISTATUS status = ColorColorExtrapolatorAllocate(COLOR_SPACE_XYZ,
                                                    &color_extrapolator);
    ...
    PSHAPE aggregate;
    status = BvhAggregateAllocate(shapes, triangles_allocated, &aggregate);
    ASSERT_EQ(status, ISTATUS_SUCCESS);

    PSCENE scene;
    status = BvhSceneAllocate(&aggregate,
                              nullptr,
                              nullptr,
                              1,
                              nullptr,
