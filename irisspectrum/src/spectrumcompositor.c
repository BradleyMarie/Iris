    ...
    )
{
    ...
    if (Spectrum0->VTable == &ReflectionSpectrumVTable &&
        Spectrum1->VTable == &ReflectionSpectrumVTable)
    {
    ...
    if (Spectrum0->VTable == &SumSpectrumVTable &&
        Spectrum1->VTable == &SumSpectrumVTable)
    {
