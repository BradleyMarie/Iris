...
TEST(AllocTest, AlignedResizeWithHeaderNoData)
{
    size_t header_size = 16;
    size_t header_alignment = 8;
    void *header;
    ...
    ASSERT_TRUE(AlignedAllocWithHeader(header_size,
                                       ...
                                       &data,
                                       &actual_allocation_size));
    void *original_header = header;
    size_t original_allocation_size = actual_allocation_size;

    ASSERT_TRUE(AlignedResizeWithHeader(original_header,
                                        original_allocation_size,
                                        header_size,
                                        header_alignment,
                                        &header,
                                        ...
                                        &data,
                                        &actual_allocation_size));
    ASSERT_EQ(original_header, header);
    EXPECT_TRUE(data == NULL);
...
TEST(AllocTest, AlignedResizeWithHeaderWithData)
{
    size_t header_size = 16;
    size_t header_alignment = 8;
    void *header;
...
TEST(AllocTest, AlignedResizeWithHeaderResizeNeeded)
{
    size_t header_size = 16;
    size_t header_alignment = 8;
    void *header;
    ...
    ASSERT_TRUE(AlignedResizeWithHeader(header,
                                        actual_allocation_size,
                                        header_size,
                                        header_alignment,
                                        &header,
...
TEST(AllocTest, AlignedResizeWithHeaderFails)
{
    size_t header_size = 16;
    size_t header_alignment = 8;
    void *header;
    ...
    void *original_header = header;
    ASSERT_FALSE(AlignedResizeWithHeader(header,
                                         actual_allocation_size,
                                         header_size,
                                         header_alignment,
                                         &header,
                                         ...
                                         &data,
                                         &actual_allocation_size));
    EXPECT_EQ(original_header, header);
