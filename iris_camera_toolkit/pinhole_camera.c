    ...
    )
{
    ...
    VECTOR3 frame_width_vector = VectorCrossProduct(direction, up);
    frame_width_vector = VectorNormalize(frame_width_vector, NULL, NULL);
    frame_width_vector = VectorScale(frame_width_vector, frame_width);

    VECTOR3 frame_height_vector = VectorCrossProduct(direction,
                                                     frame_width_vector);
    frame_height_vector = VectorNormalize(frame_height_vector, NULL, NULL);
    frame_height_vector = VectorScale(frame_height_vector, frame_height);
